...
class Dataset_Union_ALL(Dataset): 
    ...
    def __getitem__(self, index):
        ...
        if subject.label.data.sum() <= self.threshold: # object too small
            return self.__getitem__(np.random.randint(self.__len__())) # return some other image, label training pair instead(random index)
