...
from .image_encoder3D import ImageEncoderViT3D, ImageEncoderViT3D_mod
from .mask_decoder3D import MaskDecoder3D
from .prompt_encoder3D import PromptEncoder3D, PromptEncoder3D_mod
...
class Sam3D_mod(nn.Module):
    ...
    def __init__(
        ...
        """
        SAM but for img of size (img_size//4, img_size, img_size)
